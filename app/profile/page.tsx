                    ...
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                        ...
                        <div className="flex-1 text-center sm:text-left">
                            ...
                            {user.favoriteCategory && (
                                <p className="text-red-500 font-semibold">{profilePageContent.profileInfo.favoriteCategory} {user.favoriteCategory}</p>
                            )}
                        </div>
                        <div className="flex gap-4 sm:gap-6">
                            ...
                            <div className="text-center bg-zinc-800/50 px-4 py-3 rounded-lg border border-zinc-700">
                                <p className="text-2xl sm:text-3xl font-bold text-red-500">{user.favoriteCategory ? 1: 0}</p>
